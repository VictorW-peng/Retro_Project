package com.example.solution.TestUtils;
 ...
 */
@Log4j2
public class TestExcel implements ReadListener<User> {
    /**
     ...
     * @param userMapper
     */
    public TestExcel(UserMapper userMapper) {
    ...
    private void saveData() {
        ...
        userMapper.insertManyUser(cachedDataList);
        log.info("存储数据库成功！");
    }
